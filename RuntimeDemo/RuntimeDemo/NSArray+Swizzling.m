...
//    Method
//    Method method1 = class_getInstanceMethod(objc_getClass("__NSArray0"), @selector(objectAtIndex:));
//    Method swzilling_method1 = class_getInstanceMethod(objc_getClass("__NSArray0"), @selector(swzilling_objectAtIndex:));
//    method_exchangeImplementations(method1, swzilling_method1);
